...
const seeds: readonly PageSeed[] = [
  {
    ...
    englishPath: "/",
    category: "home",
    keyword: "KI Make-up Test",
    topic: "Gesichtsanalyse, Unterton und Alltagssituationen",
  ...
  },
  {
    ...
    englishPath: "/",
    category: "home",
    keyword: "test maquillage virtuel",
    topic: "diagnostic teint IA et choix de looks personnalisés",
