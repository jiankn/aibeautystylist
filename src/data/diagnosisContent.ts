...
const englishResultLabels = {
  ...
  sections: {
    ...
    analysisConfidence: "How solid this looks",
    cautions: "Go easy on these",
  },
  rows: {
    ...
    overallConfidence: "Overall read",
    limitation: "Photo limitation",
    suggestion: "Try carefully",
  },
...
> = {
  ...
  "de-DE": {
    ...
    sections: {
      ...
      analysisConfidence: "Wie stabil das wirkt",
      cautions: "Erst vorsichtig testen",
    },
    rows: {
      ...
      overallConfidence: "Gesamteinschätzung",
      limitation: "Fotolimit",
      suggestion: "Vorsichtig testen",
    },
    palettePrefix: "Palette: ",
    paletteJoiner: ", ",
    paletteOpen: " (",
  ...
  "fr-FR": {
    ...
    sections: {
      ...
      analysisConfidence: "Ce qui semble fiable",
      cautions: "À tester doucement",
    },
    rows: {
      ...
      overallConfidence: "Lecture d'ensemble",
      limitation: "Limite de la photo",
      suggestion: "À tester doucement",
    },
    palettePrefix: "Palette : ",
    paletteJoiner: ", ",
    paletteOpen: " (",
  ...
  "ja-JP": {
    ...
    sections: {
      ...
      analysisConfidence: "どれくらい安定しているか",
      cautions: "まずは薄めに試す",
    },
    rows: {
      faceShape: "顔型",
  ...
  "ko-KR": {
    ...
    rows: {
      ...
      undertone: "언더톤",
      colorSeason: "색상 방향",
      overallConfidence: "전체 판단",
      limitation: "사진상 제한",
      suggestion: "먼저 약하게 시도",
    },
    palettePrefix: "추천 색상: ",
    paletteJoiner: ", ",
    paletteOpen: " (",
  ...
  "es-ES": {
    ...
    sections: {
      ...
      analysisConfidence: "Qué tan firme se ve",
      cautions: "Pruébalo con calma",
    },
    rows: {
      ...
      overallConfidence: "Lectura general",
      limitation: "Límite de la foto",
      suggestion: "Pruébalo con calma",
    },
  ...
  "pt-BR": {
    ...
    sections: {
      ...
      analysisConfidence: "Quão estável parece",
      cautions: "Teste com leveza",
    },
    rows: {
      ...
      overallConfidence: "Leitura geral",
      limitation: "Limite da foto",
      suggestion: "Teste com leveza",
    },
    palettePrefix: "Paleta: ",
    paletteJoiner: ", ",
    paletteOpen: " (",
