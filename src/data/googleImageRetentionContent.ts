...
const googleImageRetentionTopics: readonly GoogleImageRetentionTopic[] = [
  ...
  },
  {
    ...
    lookSlug: "no-makeup",
    sourceKey: "no_makeup",
    pinVisual: "no_makeup_real_daylight",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "no_makeup_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_no_makeup_01",
    topic: withLatinFallbacks({
      en: "no-makeup makeup in real daylight",
      "zh-CN": "真实日光伪素颜妆",
      "de-DE": "No-Make-up-Make-up bei echtem Tageslicht",
      "fr-FR": "maquillage naturel en vraie lumière du jour",
      "ja-JP": "自然光で見るノーメイク風メイク",
      "ko-KR": "자연광 노메이크업 메이크업",
      "zh-TW": "真實日光偽素顏妝",
      "es-ES": "maquillaje sin maquillaje a la luz del día",
      "pt-BR": "maquiagem natural em luz do dia real",
    }),
  },
  {
    englishPath: "/for/olive-skin",
    lookSlug: "olive-undertone-rose",
    sourceKey: "olive_skin",
    pinVisual: "olive_skin_muted_rose",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "olive_skin_muted_rose_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_olive_skin_01",
    topic: withLatinFallbacks({
      en: "muted rose makeup for olive skin",
      "zh-CN": "橄榄皮灰调玫瑰妆",
      "de-DE": "gedecktes Rosé-Make-up für olivfarbene Haut",
      "fr-FR": "maquillage rose sourd pour peau olive",
      "ja-JP": "オリーブ肌向けくすみローズメイク",
      "ko-KR": "올리브 피부를 위한 뮤트 로즈 메이크업",
      "zh-TW": "橄欖皮灰調玫瑰妝",
      "es-ES": "maquillaje rosa apagado para piel oliva",
      "pt-BR": "maquiagem rosa suave para pele oliva",
    }),
  },
  {
    englishPath: "/guides/blush-placement-map",
    lookSlug: "watercolor-blush",
    sourceKey: "blush_placement",
    pinVisual: "blush_placement_map",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "watercolor_blush_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_blush_placement_01",
    topic: withLatinFallbacks({
      en: "watercolor blush placement",
      "zh-CN": "水彩腮红位置",
      "de-DE": "Aquarell-Rouge-Platzierung",
      "fr-FR": "placement du blush aquarelle",
      "ja-JP": "水彩チークの配置",
      "ko-KR": "워터컬러 블러셔 위치",
      "zh-TW": "水彩腮紅位置",
      "es-ES": "colocación de colorete acuarela",
      "pt-BR": "aplicação de blush aquarela",
    }),
  },
  {
    englishPath: "/looks/jelly-lip-tint",
    lookSlug: "jelly-lip-tint",
    sourceKey: "jelly_lip",
    pinVisual: "jelly_lip_real_daylight",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "jelly_lip_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_jelly_lip_01",
    topic: withLatinFallbacks({
      en: "jelly lip tint in real daylight",
      "zh-CN": "真实日光果冻唇妆",
      "de-DE": "Jelly-Lip-Tint bei echtem Tageslicht",
      "fr-FR": "teinte jelly pour les lèvres en vraie lumière",
      "ja-JP": "自然光で見るジェリーリップティント",
      "ko-KR": "자연광 젤리 립 틴트",
      "zh-TW": "真實日光果凍唇妝",
      "es-ES": "tinte jelly de labios con luz natural",
      "pt-BR": "lip tint jelly em luz natural",
    }),
  },
  {
    englishPath: "/looks/burgundy-velvet-makeup",
    lookSlug: "burgundy-velvet",
    sourceKey: "burgundy_velvet",
    pinVisual: "burgundy_velvet_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "burgundy_velvet_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_burgundy_velvet_01",
    topic: withLatinFallbacks({
      en: "burgundy velvet makeup",
      "zh-CN": "酒红丝绒妆",
      "de-DE": "Burgunder-Samt-Make-up",
      "fr-FR": "maquillage velours bordeaux",
      "ja-JP": "バーガンディベルベットメイク",
      "ko-KR": "버건디 벨벳 메이크업",
      "zh-TW": "酒紅絲絨妝",
      "es-ES": "maquillaje borgoña aterciopelado",
      "pt-BR": "maquiagem vinho aveludada",
    }),
  },
  {
    englishPath: "/looks/champagne-eye-glow",
    lookSlug: "reflective-lid-glow",
    sourceKey: "champagne_eye",
    pinVisual: "champagne_eye_glow_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "champagne_eye_glow_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_champagne_eye_01",
    topic: withLatinFallbacks({
      en: "champagne eye glow",
      "zh-CN": "香槟光泽眼妆",
      "de-DE": "Champagner-Augen-Make-up",
      "fr-FR": "maquillage des yeux champagne",
      "ja-JP": "シャンパンアイメイク",
      "ko-KR": "샴페인 아이 글로우",
      "zh-TW": "香檳光澤眼妝",
      "es-ES": "maquillaje de ojos champán",
      "pt-BR": "maquiagem de olhos champanhe",
    }),
  },
  {
    englishPath: "/looks/sunset-bronze-makeup",
    lookSlug: "vacation-bronze",
    sourceKey: "sunset_bronze",
    pinVisual: "sunset_bronze_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "sunset_bronze_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_sunset_bronze_01",
    topic: withLatinFallbacks({
      en: "sunset bronze makeup",
      "zh-CN": "落日古铜妆",
      "de-DE": "Sunset-Bronze-Make-up",
      "fr-FR": "maquillage bronze coucher de soleil",
      "ja-JP": "サンセットブロンズメイク",
      "ko-KR": "선셋 브론즈 메이크업",
      "zh-TW": "落日古銅妝",
      "es-ES": "maquillaje bronce de atardecer",
      "pt-BR": "maquiagem bronze de pôr do sol",
    }),
  },
  {
    englishPath: "/looks/cloud-skin-makeup",
    lookSlug: "cloud-skin-matte",
    sourceKey: "cloud_skin",
    pinVisual: "cloud_skin_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "cloud_skin_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_cloud_skin_01",
    topic: withLatinFallbacks({
      en: "cloud skin makeup",
      "zh-CN": "云朵柔雾底妆",
      "de-DE": "Cloud-Skin-Make-up",
      "fr-FR": "maquillage peau nuage",
      "ja-JP": "クラウドスキンメイク",
      "ko-KR": "클라우드 스킨 메이크업",
      "zh-TW": "雲朵柔霧底妝",
      "es-ES": "maquillaje efecto piel nube",
      "pt-BR": "maquiagem cloud skin",
    }),
  },
  {
    englishPath: "/looks/french-natural-chic",
    lookSlug: "french-natural-chic",
    sourceKey: "french_natural",
    pinVisual: "french_natural_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "french_natural_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_french_natural_01",
    topic: withLatinFallbacks({
      en: "French natural makeup",
      "zh-CN": "法式自然妆",
      "de-DE": "natürliches französisches Make-up",
      "fr-FR": "maquillage naturel français",
      "ja-JP": "フレンチナチュラルメイク",
      "ko-KR": "프렌치 내추럴 메이크업",
      "zh-TW": "法式自然妝",
      "es-ES": "maquillaje natural francés",
      "pt-BR": "maquiagem natural francesa",
    }),
  },
  {
    englishPath: "/looks/soft-berry-stain",
    lookSlug: "soft-berry-stain",
    sourceKey: "soft_berry",
    pinVisual: "soft_berry_stain_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "soft_berry_stain_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_soft_berry_01",
    topic: withLatinFallbacks({
      en: "soft berry stain makeup",
      "zh-CN": "柔和莓果染唇妆",
      "de-DE": "sanftes Beeren-Lippen-Make-up",
      "fr-FR": "maquillage lèvres teintées baie douce",
      "ja-JP": "ソフトベリーステインメイク",
      "ko-KR": "소프트 베리 스테인 메이크업",
      "zh-TW": "柔和莓果染唇妝",
      "es-ES": "maquillaje con tinte de frutos rojos suave",
      "pt-BR": "maquiagem com efeito berry suave",
    }),
  },
  {
    englishPath: "/looks/peach-morning-glow",
    lookSlug: "peach-morning-glow",
    sourceKey: "peach_morning",
    pinVisual: "peach_morning_glow_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "peach_morning_glow_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_peach_morning_01",
    topic: withLatinFallbacks({
      en: "peach morning glow makeup",
      "zh-CN": "晨光蜜桃妆",
      "de-DE": "Pfirsich-Morgen-Make-up",
      "fr-FR": "maquillage pêche lumineux du matin",
      "ja-JP": "モーニングピーチグロウメイク",
      "ko-KR": "모닝 피치 글로우 메이크업",
      "zh-TW": "晨光蜜桃妝",
      "es-ES": "maquillaje melocotón luminoso de mañana",
      "pt-BR": "maquiagem glow pêssego para manhã",
    }),
  },
  {
    englishPath: "/looks/executive-rose",
    lookSlug: "executive-rose",
    sourceKey: "executive_rose",
    pinVisual: "executive_rose_editorial",
    marketProfile: "global-diverse",
    eastAsiaPinVisual: "executive_rose_east_asia",
    eastAsiaMarketProfile: "east-asia",
    utmContent: "google_image_executive_rose_01",
    topic: withLatinFallbacks({
      en: "executive rose makeup",
      "zh-CN": "职场玫瑰妆",
      "de-DE": "Executive-Rosen-Make-up",
      "fr-FR": "maquillage rose professionnel",
      "ja-JP": "エグゼクティブローズメイク",
      "ko-KR": "이그제큐티브 로즈 메이크업",
      "zh-TW": "職場玫瑰妝",
      "es-ES": "maquillaje rosa ejecutivo",
      "pt-BR": "maquiagem rosa executiva",
    }),
  },
] as const;
